...
export const EditorLayout: React.FC = () => {
  ...
  return (
    <div className="flex w-screen h-screen bg-background overflow-hidden text-text-primary">
      {/* 1. UNIFIED APP SIDEBAR (Outer Left Column - Full Height) */}
      <AppSidebar />
